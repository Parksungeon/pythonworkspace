...
# pip install beautifulsoup4 (스크래핑 패키지)
# pip install selenium (크롤링 패키지)
...
news_button = driver.find_element(By.CSS_SELECTOR, '#lnb > div.lnb_group > div > div.lnb_nav_area._nav_area_root > div > div.api_flicking_wrap._conveyer_root > div:nth-child(8) > a'GIT )
time.sleep(1)
